...
def main():
    ...
    #     model.vision_model.video_embeddings.position_embedding.requires_grad = True
        ...
        _freeze_params(model)
        # Only language_projection and vision_adapter are tuned
    ...
    #     [cc3m_595k, cc3m_595k_zh, lain_491k, mmc4_130k_zh, coco_5k_zh, text_vqa, infographic_vqa])
    ...
    vid_zh_dataset = load_from_disk("datasets/tokenized/webvid2m_zh")
    # # concat image and video dataset
    # train_dataset = datasets.concatenate_datasets([image_dataset, vid_dataset])
    # llava_en_150k = load_from_disk("datasets/tokenized/llava_instruct_150k")
    # cc_sbu_5k = load_from_disk("datasets/tokenized/cc_sbu_5k")
    # cc_sbu_5k = datasets.concatenate_datasets([cc_sbu_5k, cc_sbu_5k, cc_sbu_5k, cc_sbu_5k, cc_sbu_5k])
    # cc_sbu_5k = datasets.concatenate_datasets([cc_sbu_5k, cc_sbu_5k, cc_sbu_5k, cc_sbu_5k, cc_sbu_5k])
    # llava_zh_100k = load_from_disk("datasets/tokenized/llava_instruct_100k_zh")
    # zh_data = datasets.concatenate_datasets([cc_sbu_5k, llava_zh_100k])
    # zh_data = zh_data.shuffle(seed=42).shuffle(42)
    #
    # vqa2 = load_from_disk("datasets/tokenized/VQAv2.0")
    # paragraph_caps = load_from_disk("datasets/tokenized/image_paragraph_caps")
    # en_data = datasets.concatenate_datasets([llava_en_150k, vqa2, vqa2, paragraph_caps, paragraph_caps])
    # en_data = en_data.shuffle(seed=42)
    #
    # train_dataset = datasets.concatenate_datasets([zh_data, en_data])
    train_dataset = vid_zh_dataset
