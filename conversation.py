...
conv_templates = {
    ...
    "husky": conv_husky,
    "zh_husky": conv_zh_husky,
    "multi_model": conv_multi_model,
}

def get_default_conv_template(model_name):
    model_name = model_name.lower()
    if "zh_husky" in model_name:
        return conv_zh_husky
    elif "husky" in model_name or "llama" in model_name:
        return conv_husky
